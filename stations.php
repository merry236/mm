...
<th style='height:30px;	text-align:center;color:#000;	font-weight:bold;background-color:#3C5581;'><font color='white' size='2'>Kebele</th>
<th style='height:30px;	color:#000;	text-align:center;  font-weight:bold;background-color:#3C5581;'><font color='white' size='2'>City</th>
...
<?php
$result = $conn->query("SELECT * FROM station");
...
?>
<tr>
<td style="text-align:center"><?php echo $psregion;?></td>
<td style="text-align:center"><?php echo $pszone;?></td>
