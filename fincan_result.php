...
$result=$conn->query("select * from candidate where c_id='$user_id'")or die(mysqli_error);
...
?>
 ...
 <tr>
 <th colspan="2" bgcolor="#3C5581"><font color="white" style="text-transform:uppercase;"><?php echo $r12;?>&nbsp;&nbsp;Party</font><a href="can_result.php" title="Close"><img src="img/close_icon.gif" align="right"></a></th>
 </tr>
 <tr>
 <td><table>
