...
?>
 ...
 <tr>
 <th colspan="2" bgcolor="#3C5581"><font color="white">Edit User Account</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="elect_registrar.php" title="Close"><img src="img/close_icon.gif"></a></th>
 </tr>
<tr>
...
?>
 ...
 <?php
  ...
  $update = $conn->query("update user set fname='$fname',mname='$mname',lname='$lname', sex='$sex',role='registrar',username='$username' 
	,password='$password'
