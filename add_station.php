...
{
$sql="INSERT INTO station (u_id,region,zone,psname,kebele,city)
VALUES
('$user_id','$psregion','$pszone','$psname','$kebele','$city')";
...
<tr bgcolor="#3C5581" ><th height="30px" colspan="2" ><font color="#ffffff">Add new Polling station</font><a href="stations.php"><img align="right"src="img/close_icon.gif" title="close"></a></th></tr>
<tr>
<td><br>
</td>
<td>
...
<td>
<input type="text" name="region" maxlength="10" required/>
</td>
</tr>
<tr>
<td>
...
<td>
<input type="text" name="zone" maxlength="10" required/>
</td>
</tr>
<tr>
<td>
